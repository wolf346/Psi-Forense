...
ITEMS_MMPI2RF = [
    ...
    "29. Tiendo a tomar los desengaños tan a pecho que no puedo dejar de pensar en ellos.",
    ...
    "113. Tiendo a dejar de hacer algo que deseo cuando los demás piensan que esa no es la manera correcta de hacerlo.",
    ...
    "122. He tenido ataques durante los cuales no podía controlar el habla o los movimientos, pero me daba cuenta de lo que ocurria a mi alrededor.",
